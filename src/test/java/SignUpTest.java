...
public class SignUpTest {
    ...
    public void test() {
        ...
        driver.findElement(By.name("first_name")).sendKeys("Artem");
        driver.findElement(By.name("last_name")).sendKeys("Petrovich");
        driver.findElement(By.name("email")).sendKeys("mangol@mail.ru");
